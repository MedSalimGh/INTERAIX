...
// Ensure dayjs uses UTC to prevent hydration mismatches
dayjs.extend(utc);
      ...
      <div className="card-interview">
        <div>
          ...
          <Image
            ...
            width={90}
            height={90}
            className="rounded-full object-corver size-[90px]"
          />
        ...
        <div className="flex flex-row justify-between">
          <DisplayTechIcons techStack={techstack} className="size-10" />
